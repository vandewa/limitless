...
<head>
	...
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/inputmask.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/autosize.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/formatter.min.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/typeahead/handlebars.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/passy.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/maxlength.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/extensions/jquery_ui/core.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/tags/tokenfield.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/tags/tagsinput.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/ui/prism.min.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/forms/inputs/duallistbox/duallistbox.min.js')}}"></script>
	...
	<script src="{{ asset('limitless/global_assets/js/plugins/extensions/cookie.js')}}"></script>
	...
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/trumbowyg.min.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/base64/trumbowyg.base64.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/cleanpaste/trumbowyg.cleanpaste.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/colors/trumbowyg.colors.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/insertaudio/trumbowyg.insertaudio.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/noembed/trumbowyg.noembed.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/preformatted/trumbowyg.preformatted.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/template/trumbowyg.template.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/upload/trumbowyg.upload.js')}}"></script>
	<script
		src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/pasteimage/trumbowyg.pasteimage.js')}}"></script>
	...
	<script src="{{ asset('limitless/global_assets/js/plugins/pickers/color/spectrum.js')}}"></script>
	...
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_multiselect.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_input_groups.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_controls_extended.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_floating_labels.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_tags_input.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_dual_listboxes.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_validation.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_wizard.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/form_actions.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/editor_summernote.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/editor_ckeditor.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/editor_trumbowyg.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/picker_date.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/demo_pages/picker_color.js')}}"></script>
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Components -->
						<li class="nav-item-header">
							<div class="text-uppercase font-size-xs line-height-xs">Components</div> <i
								class="icon-menu" title="Components"></i>
						</li>
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Page layouts">
								...
								<li class="nav-item"><a href="layout_fixed_hideable_navbar.html"
										class="nav-link">Hideable navbar</a></li>
							...
							<ul class="nav nav-group-sub" data-submenu-title="Sidebars">
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="sidebar_default_hide.html"
												class="nav-link">Default hideable</a></li>
										<li class="nav-item"><a href="sidebar_default_hidden.html"
												class="nav-link">Default hidden</a></li>
								...
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="sidebar_right_default_hide.html"
												class="nav-link">Show - hide main</a></li>
										...
										<li class="nav-item"><a href="sidebar_right_mini_toggle.html"
												class="nav-link">Show - fix mini width</a></li>
										<li class="nav-item"><a href="sidebar_right_secondary_hide.html"
												class="nav-link">Show - hide secondary</a></li>
										<li class="nav-item"><a href="sidebar_right_visible.html"
												class="nav-link">Visible by default</a></li>
										<li class="nav-item-divider"></li>
								...
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="navbar_single_top_static.html"
												class="nav-link">Single top static</a></li>
										<li class="nav-item"><a href="navbar_single_top_fixed.html"
												class="nav-link">Single top fixed</a></li>
							...
							<ul class="nav nav-group-sub" data-submenu-title="Dimple library">
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="dimple_lines_vertical.html"
												class="nav-link">Vertical orientation</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="dimple_bars_horizontal.html"
												class="nav-link">Horizontal orientation</a></li>
										<li class="nav-item"><a href="dimple_bars_vertical.html"
												class="nav-link">Vertical orientation</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="dimple_area_horizontal.html"
												class="nav-link">Horizontal orientation</a></li>
										<li class="nav-item"><a href="dimple_area_vertical.html"
												class="nav-link">Vertical orientation</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="dimple_step_horizontal.html"
												class="nav-link">Horizontal orientation</a></li>
										<li class="nav-item"><a href="dimple_step_vertical.html"
												class="nav-link">Vertical orientation</a></li>
									</ul>
								</li>
						...
						<!-- Extensions -->
						<li class="nav-item-header">
							<div class="text-uppercase font-size-xs line-height-xs">Extensions</div> <i
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-file-spreadsheet"></i>
							...
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								...
								<li class="nav-item"><a href="handsontable_custom_checks.html" class="nav-link">Custom
										&amp; checkboxes</a></li>
								<li class="nav-item"><a href="handsontable_ac_password.html"
										class="nav-link">Autocomplete &amp; password</a></li>
