...
<head>
	...
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/base64/trumbowyg.base64.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/cleanpaste/trumbowyg.cleanpaste.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/colors/trumbowyg.colors.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/insertaudio/trumbowyg.insertaudio.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/noembed/trumbowyg.noembed.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/preformatted/trumbowyg.preformatted.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/template/trumbowyg.template.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/upload/trumbowyg.upload.js')}}"></script>
	<script src="{{ asset('limitless/global_assets/js/plugins/editors/trumbowyg/plugins/pasteimage/trumbowyg.pasteimage.js')}}"></script>
