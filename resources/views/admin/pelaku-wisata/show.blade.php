                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <ul class="nav nav-sidebar mb-2">
                                        ...
                                        <li class="nav-item">
                                            <a href="#profile"
                                                class="nav-link @if (session('biaya')) active @endif"
                                                data-toggle="tab">
                                        ...
                                        <li class="nav-item">
                                            <a href="#schedule"
                                                class="nav-link @if (session('omzet')) active @endif"
                                                data-toggle="tab">
                                        ...
                                        <li class="nav-item">
                                            <a href="#inbox"
                                                class="nav-link @if (session('pajak')) active @endif"
                                                data-toggle="tab">
                                        ...
                                        <li class="nav-item">
                                            <a href="#serti2"
                                                class="nav-link @if (session('serti2')) active @endif"
                                                data-toggle="tab">
    ...
    <script type="text/javascript">
        ...
        var table = $('.certificate').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'jenis_sertifikat.code_nm',
                    name: 'jenisSertifikat.code_nm'
                },
                {
                    data: 'nama',
                    name: 'nama',
...
@push('after-script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\SertifikatStoreValidation', '#serti2') !!}
@endpush
