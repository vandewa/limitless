                ...
                <div class="card-body">
                    ...
                    <div class="row font-size-lg">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">Harga Tiket</div>
                                <div class="col-md-9">: {{ $lokasi->harga_tiket }}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">Jam Operasional</div>
                                <div class="col-md-9">: {{ $lokasi->jam_operasional }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href='https://wa.me/{{ konversi_nomor($lokasi->no_wa) }}?text=Yth. Bapak/Ibu {{ ' *' .
                        ...
                        ini:%0D%0A%0D%0A{{ url('/kunjungan-wisata/create?lokasi_id=' . $lokasi->id . '%26tahun=' .
                        date('Y') . '%26bulan=' . date('m')) }}%0D%0A%0D%0ATerima Kasih.'
