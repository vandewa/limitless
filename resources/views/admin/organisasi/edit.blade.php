    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {{Form::model($data, ['route' => ['organisasi.update', $data->id],'method' => 'put', 'id' => 'my-form'])}}
                    @include('admin.organisasi.form')
                    {{Form::close()}}
                </div>
            </div>
            <!-- /form inputs -->
...
{!! JsValidator::formRequest('App\Http\Requests\OrganisasiStoreValidation','#my-form') !!}
@endpush
