                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <ul class="nav nav-sidebar mb-2">
                                        ...
                                        <li class="nav-item">
                                            <a href="#pelatihan"
                                                class="nav-link @if (session('pelatihan')) active @endif"
                                                data-toggle="tab">
                                        ...
                                        <li class="nav-item">
                                            <a href="#serti"
                                                class="nav-link @if (session('serti')) active @endif"
                                                data-toggle="tab">
...
@push('after-script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\SertifikatStoreValidation', '#serti') !!}
@endpush
